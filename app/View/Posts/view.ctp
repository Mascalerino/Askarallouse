            ...
            <div class=" col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <div class="row">
                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                  ...
                  <p  style="font-size:12px;"><?= $post['Post']['content']; ?></p>    
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <div class="row">
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                  <div class="answer">
                  <?php //echo $this->Form->submit('Responder', array('div' => false, 'class' => 'btn btn-info', 'data-toggle' => 'modal', 'data-target' => '#answerModal')); ?>
            ...
            <div class=" col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <div class="row">
                ...
                <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                  <h5><?php echo $response['responses']['content']; ?></h5> 
                </div>
                <div class="hidden-xs col-sm-2 col-md-2 col-lg-2"></div>
                <div class="col-xs-4 col-sm-2 col-md-2 col-lg-2">
                  <?php echo $this->Html->image('new_logo.jpg', array('alt' => 'avatar', 'class' => 'img-responsive center-block')); ?>
              ...
              <div class="row">
                ...
                <div class="col-xs-3 col-sm-3 col-md-2 col-lg-2">
                  <div class="positive">
                    ...
                    <span class="glyphicon glyphicon-thumbs-up" title="positive">5</span></button>
                  </div>
                </div>
                <div class="col-xs-3 col-sm-3 col-md-2 col-lg-2">
                  <div class="negative">
                    <button type="button" class="btn btn-default" arial-label="left-align">
                    <span class="glyphicon glyphicon-thumbs-down" title="negative">2</span></button>
                  </div>
                </div>              
              </div>
            </div>
