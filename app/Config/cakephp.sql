...
(NULL, '¿Como robar la contraseña del WiFi de mi vecino?', 'Hola, quisiera saber como robar la contraseña de la WiFi de mi vecino. Se la he pedido amablemente pero se ha negado a compartirla.', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, NULL, '2'), 
(NULL, '¿Como crear un PDF?', 'Tengo un trabajo en Word y no se como convertirlo a PDF', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, NULL, '2'), 
(NULL, '¿Como declaro una variable en C++?', 'He empezado un tutorial pero no me han enseñado a declarar variables en C++.', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, NULL, '3'),
(NULL, '¿Como hacer una copia de mi disco duro?', 'Ya he fotocopiado mi disco duro, pero no se como puedo obtener los datos de esta copia. Ayudenme gracias.', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, NULL, '3');

INSERT INTO `responses` (`id`, `content`, `modDate`, `initDate`, `utility`, `user_id`, `post_id`) VALUES 
(NULL, 'Debes dirigirte al archivo httpd.conf y ahí cambias el puerto.', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, '2', '1'), 
(NULL, 'Dirigite al panel de XAMPP ahi encontrarás la respuesta.', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, '3', '1'), 
(NULL, 'Mirate un tutorial en YouTube. Programa en CakePhp, puedes consultar los tutoriales de edson mollericona.', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, '2', '2'), 
(NULL, 'Es dificil responder a esta pregunta.', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, '3', '2'), 
(NULL, 'Utiliza WifiSlax, es muy intuitivo', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, '1', '3'), 
(NULL, 'Paga el internet y deja de robar.', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, '3', '3'), 
...
(NULL, '¿En serio preguntas eso?', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, '3', '4'), 
(NULL, 'Es imposible que no te hayan explicado eso, si estas mirando un tutorial en YouTube.', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, '1', '2'), 
(NULL, 'Supongo que cuando ves el tutorial, él declara variables, puedes aprender de ahí.', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, '2', '5'),
(NULL, 'Madre mía, como pilotas en el asunto.', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, '1', '6'), 
(NULL, '¿De donde te has escapado?', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000', NULL, '2', '6');
